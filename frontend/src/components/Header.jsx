...
const Header = () => {
  return (
    <div className='w-[90%] mt-[2rem] gap-[1rem] md:gap-0 mx-auto flex flex-col md:flex-row justify-between items-center'>
      ...
      <div className="flex items-center gap-[0.9rem] mb-4 md:mb-0">
        <div className="flex justify-start">
          <img src='./images/du_logo.png' className='w-[90%] max-w-[100px] md:max-w-[120px]' alt="DU Logo" />
        </div>
        <div className='text-center md:text-left'>
          <h2 className='text-[1.5rem] md:text-[2rem] font-instrument text-[#72265F]'>Placement Cell, DUCS</h2>
          <hr className='border-[1.5px] rounded-sm border-[#7a408f]' />
          <h4 className='text-[1rem] md:text-[1.5rem] text-[#72265F] font-instrument'>University of Delhi</h4>
        </div>
      </div>
      ...
      <div className="flex flex-row md:flex-row items-center gap-[4rem] md:gap-[4rem] text-[#72265F]">
        ...
        <h2 className='cursor-pointer font-instrument text-[0.875rem] md:text-[1rem]'>About Us</h2>
        <Button 
